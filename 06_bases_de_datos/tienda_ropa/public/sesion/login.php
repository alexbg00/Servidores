...
<body class="bg-info d-flex justify-content-center align-items-center vh-100">
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($resultado->num_rows > 0) {
      ...
      if ($acceso_valido) {
        ...
        $_SESSION["rol"] = $rol;
        header("Location: http://06_bases_de_datos.test/tienda_ropa/public/");
      } else { ?>
  ...
  <div class="bg-white p-5 rounded-5 text-secondary shadow" style="width: 25rem">
    ...
    <div class="d-flex justify-content-around mt-1">
      ...
      <div class="pt-1">
        <a href="#" class="text-decoration-none text-info fw-semibold fst-italic" style="font-size: 0.9rem">Recuperar contraseña (inop)</a>
      </div>
    </div>
    ...
    <div class="d-flex gap-1 justify-content-center mt-1">
      ...
      <a href="../clientes/registro.php" class="text-decoration-none text-info fw-semibold">Registrarte</a>
    </div>
